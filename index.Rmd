...
This site is a collaboration between a clinician and a computer scientist to help bridge the gap in the paucity of homeless health data.  Please click on the tabs above to create your own graphs where mortality and population level data can be viewed.
...
renderPlot({
  hist(faithful$eruptions, probability = TRUE, breaks = as.numeric(input$Alcohol),
       xlab = "Duration (minutes)", main = "Geyser eruption duration")
  
  dens <- density(faithful$eruptions, adjust = input$Alcohol/1000)
  lines(dens, col = "blue")
})
```
...
![Miqdad Asaria](miq.jpg)  
**Miqdad Asaria BEng MSc MSc**  
...
![Khalil Hassanally](khalil.jpg)  
**Dr Khalil Hassanally BSc MBBS LLB MRCGP MA**    
